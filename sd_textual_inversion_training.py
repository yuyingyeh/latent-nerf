...
def main():
    ...
    parser.add_argument('--pretrained_model_name_or_path', default='/openroomssubstance/yyeh/threestudio/runwayml/stable-diffusion-v1-5')
    parser.add_argument('--concept_name', default='meta_chair0_multi')
    parser.add_argument('--initializer_token', default='chair')
    ...
    save_path = "/openroomssubstance/yyeh/threestudio/dreambooth_imgs/%s" % concept_name
    ...
    output_concept_dir = "sd-concepts-library/%s" % concept_name
    if os.path.exists(os.path.join(output_concept_dir, 'learned_embeds.bin')):
        print('Concept exists! No need to train!')
        return True
